# Project: Go Backend Workflow (Example)

> Example template for a Go backend project. Copy this file to CLAUDE.md
> and adapt to your stack. For the canonical genericity primitive, populate
> `.claude/PROJECT-KNOWLEDGE.md` (see `.claude/PROJECT-KNOWLEDGE.md.example`).
