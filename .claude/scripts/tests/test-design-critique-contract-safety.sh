...
# CS-1b: no design-critic / design-reviewer agent wired anywhere in settings — the design
# critique runs in the /designer command context only, never as a delegated review agent.
